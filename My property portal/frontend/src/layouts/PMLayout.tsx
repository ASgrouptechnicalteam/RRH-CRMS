...
const PMLayout = () => {
  ...
  const navItems = [
    ...
    { label: 'Projects', path: '/pm/projects', icon: Building2 },
    { label: 'Payment Verifications', path: '/pm/payments', icon: FileText },
    ...
    <div className="flex h-screen bg-slate-950 text-slate-200 font-sans">
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
        ...
        <div className="p-4 border-b border-slate-800">
          ...
          <p className="font-medium text-slate-200 truncate">{user?.name || 'Project Manager'}</p>
        </div>
