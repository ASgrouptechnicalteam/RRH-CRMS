...
export class DocumentGenerationService {
  ...
  static async generateAndUploadDocument(
    user: TokenPayload,
    html: string,
    filename: string,
    data: {
    ...
    return DocumentService.uploadDocument(user, file as Express.Multer.File, data);
  }

  static async generateReceipt(user: TokenPayload, paymentId: number) {
    ...
    return this.generateAndUploadDocument(
      user,
      html,
      `Receipt_${payment.payment_code}.pdf`,
      {
  ...
  static async generateAgreement(user: TokenPayload, bookingId: number) {
    ...
    return this.generateAndUploadDocument(
      user,
      html,
      `Agreement_${booking.booking_code}.pdf`,
      {
