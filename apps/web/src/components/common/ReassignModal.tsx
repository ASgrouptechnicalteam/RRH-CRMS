  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        ...
        const validEmployees = (data.employees || []).filter(
          (e: EmployeeListItem) => e.id !== currentAssigneeId && e.status === 'ACTIVE',
        );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-800">
                Reassign {entityType.charAt(0).toUpperCase() + entityType.slice(1)}
              </h2>
        ...
        <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
            ...
            <div className="text-sm text-amber-800 font-medium">
              This action will be permanently recorded in the system audit logs. The new assignee
