...
CREATE TABLE `AttendanceLog` (
    ...
    `branch_id` INTEGER NULL,
    `checkout_branch_id` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `AttendanceLog` ADD CONSTRAINT `AttendanceLog_created_by_id_fkey` FOREIGN KEY (`created_by_id`) REFERENCES `Employee`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Lead` ADD CONSTRAINT `Lead_demo_handler_id_fkey` FOREIGN KEY (`demo_handler_id`) REFERENCES `Employee`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
